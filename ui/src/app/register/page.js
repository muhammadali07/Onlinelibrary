    ...
    <main className='flex flex-col items-center justify-center w-full flex-1 px-20 text-center'>
      <div className='bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-screen-4xl'>
        <div className='w-3/5 p-5'>
          ...
          <div className='py-10'>
            <h2 className='text-3xl font-bold text-green-500 mb-2'>Sign up Account</h2>
            ...
            <div className='flex flex-col items-center'>
              ...
              <div className='bg-gray-100 w-64 p-2 flex items-center mb-3 rounded-full'><MdLockOutline className='text-gray-400 mr-2' />
                <input type="text" name='usernmae' placeholder='Username ' className='bg-gray-100 outline-none text-sm flex-1' />
              </div>
              <div className='bg-gray-100 w-64 p-2 flex items-center mb-3 rounded-full'><MdLockOutline className='text-gray-400 mr-2' />
        ...
        <div className='w-2/5 bg-green-500 text-white rounded-tr-2xl rounded-br-2xl py-36 px-12'>
          <h2 className='text-3xl font-bold mb-2'>I'm ready</h2>
